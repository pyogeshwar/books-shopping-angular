...
describe('MyOrdersComponent', () => {
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      ...
      declarations: [BooksComponent, MyOrdersComponent],
      providers: [
        BooksFacade,
        provideMockStore({
          initialState,
  ...
  // it(
  //   'should assign orderedBooks$ when component is resolved',
  //   waitForAsync(() => {
  //     component.orderedBooks$.forEach((element) => {
  //       expect(element[0].id).toEqual('hbE4DwAAQBAJ');
  //     });
  //   })
  // );
});
