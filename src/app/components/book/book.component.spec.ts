...
describe('BookComponent', () => {
    ...
    await TestBed.configureTestingModule({
      imports: [
        ...
        RouterTestingModule.withRoutes([
          { path: 'billing', component: BookComponent },
        ]),
      ],
  ...
  it(
    'should call viewBook() method when component is resolved ',
    waitForAsync(() => {
      spyOn(component, 'ngOnInit').and.callThrough();
      spyOn(component, 'viewBook').and.callThrough();
  ...
  it('should call addBookToCart() method ', inject(
    [BooksFacade],
    (facade: BooksFacade) => {
      spyOn(component, 'addBookToCart').and.callThrough();
      const spy = spyOn(facade, 'addToCart');

      component.addBookToCart(bookDetails);
      fixture.detectChanges();
