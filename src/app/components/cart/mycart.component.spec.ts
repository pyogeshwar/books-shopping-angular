...
describe('MyCartComponent', () => {
  ...
  let router;
  let mockCartBooksSelector: MemoizedSelector<booksReducer.State, any>;
  const initialState = [
    {
      kind: 'books#volume',
      id: 'hbE4DwAAQBAJ',
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [
        ...
        RouterTestingModule.withRoutes([
          { path: 'billing', component: MyCartComponent },
        ]),
      ],
      declarations: [BooksComponent, MyCartComponent],
      providers: [
        BooksFacade,
        provideMockStore({
          initialState,
    ...
    const getBookFeatureState = createFeatureSelector<booksReducer.BooksState>(
      'books'
    );
  ...
  it('should call proceedToBuy() method and navigate to billingDetails page', inject(
    ...
    (facade: BooksFacade) => {
      ...
      const finalItemListSpy = spyOn(facade, 'finalItemList');
      component.proceedToBuy([book]);
      expect(proceedToBuySpy).toHaveBeenCalled();
