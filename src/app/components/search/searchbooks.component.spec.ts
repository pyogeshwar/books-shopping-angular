...
describe('SearchBooksComponent', () => {
    ...
    await TestBed.configureTestingModule({
      imports: [
        ...
        RouterTestingModule.withRoutes([
          { path: 'billing', component: SearchBooksComponent },
        ]),
      ],
      declarations: [BooksComponent, SearchBooksComponent],
      providers: [
        BooksFacade,
        provideMockStore({
          initialState,
  ...
  it('should call searchInputChange() method and navigate to billing page', inject(
    ...
    (facade: BooksFacade) => {
      ...
      const finalItemListSpy = spyOn(facade, 'loadBooks');
      component.searchInputChange([book]);
